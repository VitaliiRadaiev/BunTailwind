...
//Development Tasks
function devHTML(){
  return src([`${options.paths.src.base}/**/*.html`, "!" + options.paths.src.base + "/**/**/_*.html"])
  .pipe(fileinclude())
...
function watchFiles(){
  ...
  watch([options.config.tailwindjs, `${options.paths.src.base}/**/**/*.scss`],series(devStyles, previewReload));
  watch(`${options.paths.src.js}/**/**/*.js`,series(devScripts, previewReload));
  watch(`${options.paths.src.base}/components/**/*.js`,series(devScripts, previewReload));
